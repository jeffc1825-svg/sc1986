...
3. 動 UI 前先讀 skill `.claude/skills/ui-design/`;動資料庫前先讀 `.claude/skills/database/`;收尾驗證用 `.claude/skills/qa-release/`。
...
高風險變更(權限、詢價交易、草稿發布、匯入)另需依 `.claude/skills/qa-release/` 的清單人工驗證主要流程。
